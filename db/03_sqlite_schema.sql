...
VALUES
    (1, 'THO-CELADON-S', 'Bình men celadon oval', 'decor', 'Men xanh nhẹ', 380000, NULL, 8, 4.8, 24),
    (2, 'THO-DIY-KIT', 'Bộ DIY Kit tô màu men', 'kit', 'Tự tay làm gốm', 220000, NULL, 24, 4.7, 18),
    (3, 'THO-CUP-MOON', 'Ly gốm trắng ánh trăng', 'cup', 'Bàn trà chậm', 260000, NULL, 14, 4.9, 31),
    (4, 'THO-VASE-SAND', 'Lọ hoa thân cao đất mộc', 'decor', 'Đất mộc hiện đại', 760000, NULL, 5, 4.6, 12),
    (5, 'THO-PLATE-LOTUS', 'Đĩa sen vẽ tay', 'tableware', 'Bàn ăn nghệ thuật', 540000, NULL, 0, 4.8, 20),
    (6, 'THO-PLATE-STONE', 'Đĩa đá mộc', 'tableware', 'Bàn ăn nghệ thuật', 460000, NULL, 7, 4.6, 18),
    (7, 'THO-VASE-BLACK', 'Bình đen khói', 'decor', 'Đất mộc hiện đại', 820000, NULL, 4, 4.9, 16),
    (8, 'THO-VASE-SAND', 'Bình cát biển', 'decor', 'Đất mộc hiện đại', 690000, NULL, 6, 4.7, 19),
    (9, 'THO-JAR-MILK', 'Hũ sữa men kem', 'decor', 'Men sữa', 330000, NULL, 10, 4.8, 27),
    (10, 'THO-TRAY-CLOUD', 'Khay mây men trắng', 'decor', 'Men sữa', 290000, NULL, 11, 4.7, 15),
    (11, 'THO-INCENSE-ASH', 'Đế hương tro xám', 'decor', 'Men khói', 180000, NULL, 18, 4.6, 13),
    (12, 'THO-CANDLE-CLAY', 'Chén nến đất nung', 'decor', 'Men khói', 240000, NULL, 14, 4.8, 21),
    (13, 'THO-KIT-FAMILY', 'DIY kit gia đình', 'kit', 'Tự tay làm gốm', 620000, NULL, 8, 4.9, 29),
    (14, 'THO-KIT-COUPLE', 'DIY kit cặp đôi', 'kit', 'Tự tay làm gốm', 390000, NULL, 12, 4.8, 25),
    (15, 'THO-SCULPT-BIRD', 'Tượng gốm chim nhỏ', 'decor', 'Tượng nhỏ', 350000, NULL, 6, 4.6, 11),
    (16, 'THO-SCULPT-HOUSE', 'Nhà gốm mini', 'decor', 'Tượng nhỏ', 410000, NULL, 3, 4.8, 14),
    (17, 'THO-LAMP-WARM', 'Đèn gốm ánh ấm', 'decor', 'Ánh sáng gốm', 1180000, NULL, 2, 4.9, 9),
    (18, 'THO-LAMP-MOON', 'Đèn trăng men sữa', 'decor', 'Ánh sáng gốm', 1320000, NULL, 0, 4.9, 7),
    (19, 'THO-CUP-DAWN', 'Ly sứ bình minh', 'cup', 'Bàn trà chậm', 260000, NULL, 12, 4.8, 34),
    (20, 'THO-CUP-MOSS', 'Cặp ly men rêu', 'cup', 'Bàn trà chậm', 420000, NULL, 9, 4.9, 41),
    (21, 'THO-CUP-SOUL', 'Ly gốm mộc bản', 'cup', 'Bàn trà chậm', 290000, NULL, 15, 4.8, 16),
    (22, 'THO-PLATE-LEAF', 'Đĩa tạo hình chiếc lá', 'tableware', 'Bàn ăn nghệ thuật', 340000, NULL, 10, 4.7, 12),
    (23, 'THO-PLATE-CELADON', 'Đĩa men ngọc Celadon', 'tableware', 'Men xanh nhẹ', 320000, NULL, 12, 4.8, 15),
    (24, 'THO-BOWL-CELADON', 'Bát ăn men ngọc', 'tableware', 'Men xanh nhẹ', 280000, NULL, 14, 4.9, 19),
    (25, 'THO-CUP-CELADON', 'Ly men ngọc dáng lùn', 'cup', 'Men xanh nhẹ', 220000, NULL, 8, 4.7, 11),
    (26, 'THO-VASE-ROCK', 'Lọ hoa mộc vân đá', 'decor', 'Đất mộc hiện đại', 720000, NULL, 5, 4.8, 14),
    (27, 'THO-CUP-MILK', 'Ly quai tròn men sữa', 'cup', 'Men sữa', 270000, NULL, 13, 4.8, 22),
    (28, 'THO-PLATE-MILK', 'Đĩa tròn men sữa viền nâu', 'tableware', 'Men sữa', 310000, NULL, 9, 4.7, 18),
    (29, 'THO-BOWL-ASH', 'Bát trà men khói trầm', 'tableware', 'Men khói', 290000, NULL, 11, 4.8, 14),
    (30, 'THO-HOLDER-SMOKE', 'Đế hương men đen khói', 'decor', 'Men khói', 160000, NULL, 20, 4.6, 8),
    (31, 'THO-KIT-SOLO', 'DIY kit cá nhân tự làm', 'kit', 'Tự tay làm gốm', 250000, NULL, 15, 4.8, 30),
    (32, 'THO-SCULPT-FISH', 'Tượng cá nhỏ tối giản', 'decor', 'Tượng nhỏ', 380000, NULL, 7, 4.7, 12),
    (33, 'THO-SCULPT-CAT', 'Tượng mèo lười cuộn tròn', 'decor', 'Tượng nhỏ', 340000, NULL, 10, 4.9, 25),
    (34, 'THO-LAMP-DESK', 'Đèn bàn gốm cổ điển', 'decor', 'Ánh sáng gốm', 1250000, NULL, 4, 4.8, 10),
    (35, 'THO-LAMP-STONE', 'Đèn ngủ gốm mộc dáng nấm', 'decor', 'Ánh sáng gốm', 980000, NULL, 6, 4.7, 5);
